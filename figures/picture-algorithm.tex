...
\begin{tikzpicture}
  \pgfmathsetlength{\vertSmall}{3ex}
  \pgfmathsetlength{\vertBig}{4ex}
  \pgfmathsetlength{\vertBigger}{6ex}
  ...
  \draw ($(w0) + (offset)$) -- node[at start,below=-2pt] {\tiny I} ($(w1) - (offset)$);
  \draw ($(w1) + (offset)$) -- node[at start,below=-2pt] {\tiny I} ($(w2) - (offset)$);
  \draw ($(w2) + (offset)$) -- node[at start,below=-2pt] {\tiny I} ($(w3) - (offset)$);
  \draw ($(w3) + (offset)$) -- node[at start,below=-2pt] {\tiny I} ($(w4) - (offset)$);
  \draw ($(w4) + (offset)$) -- node[at start,below=-2pt] {\tiny I} ($(w5) - (offset)$);
  \draw ($(w5) + (offset)$) -- node[at start,below=-2pt] {\tiny I} ($(w6) - (offset)$);
  \node [anchor=west] (step0) at (w6 |- v0) {\strut \tiny Initialize};

  \draw ($(w0 |- v1) + (offset)$) -- node[at start,below=-2pt] {\tiny X} ($(w1 |- v1) - (offset)$);
  \node [extPoint] at (w2 |- v1) {};
  \draw ($(w1 |- v1) + (offset)$) -- node[at start,below=-2pt] {\tiny I} ($(w2 |- v1) - (offset)$);
  \draw ($(w3 |- v1) + (offset)$) -- node[at start,below=-2pt] {\tiny I} ($(w4 |- v1) - (offset)$);
  \draw ($(w4 |- v1) + (offset)$) -- node[at start,below=-2pt] {\tiny I} ($(w5 |- v1) - (offset)$);
  ...
  \node [anchor=west] (step0) at (w6 |- v1) {\strut \tiny Add edges};

  \draw ($(w2 |- v2) + (offset)$) -- node[at start,below=-2pt] {\tiny I} ($(w4 |- v2) - (offset)$);
  \draw ($(w4 |- v2) + (offset)$) -- node[at start,below=-2pt] {\tiny I} ($(w6 |- v2) - (offset)$);
  \draw [leftChild,len1] ($(w3 |- v2) + (offset)$) to ($(w4 |- v2) - (offset) + (voffset0)$);
  \draw [rightChild,len1] ($(w4 |- v2) + (offset) + (voffset0)$) to ($(w5 |- v2) - (offset)$);
  \node [anchor=west] (step0) at (w6 |- v2) {\strut \tiny Combine};

  \draw ($(w2 |- v3) + (offset)$) -- node[at start,below=-2pt] {\tiny X} ($(w4 |- v3) - (offset)$);
  ...
  \node [anchor=west] (step0) at (w6 |- v3) {\strut \tiny Add edges};

  \draw ($(w2 |- v4) + (offset)$) -- node[at start,below=-2pt] {\tiny N} ($(w6 |- v4) - (offset)$);
  ...
  \node [anchor=west] (step0) at (w6 |- v4) {\strut \tiny Combine};

  \draw ($(w2 |- v5) + (offset)$) -- node[at start,below=-2pt] {\tiny N} ($(w6 |- v5) - (offset)$);
  ...
  \node [anchor=west] (step0) at (w6 |- v5) {\strut \tiny Add edges};

  \draw ($(w0 |- v6) + (offset)$) -- node[at start,below=-2pt] {\tiny I} ($(w6 |- v6) - (offset)$);
  ...
  \node [anchor=west] (step0) at (w6 |- v6) {\strut \tiny Combine};
\end{tikzpicture}
