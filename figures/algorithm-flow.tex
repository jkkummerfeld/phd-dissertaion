...
\begin{tikzpicture}
  ...
  \node (endX) at (6,0.2) {\S~\ref{sec:alg:exterval}};
  \node (endB) at (9,0.2) {\S~\ref{sec:alg:both}};
  ...
  \node (q1s) at ($(q1p)!0.35!(q1q)$) {};
  \node (q1a) at ($(q1p)!0.5!(q1q)$) {};
  \node (q1c) at ($(q1p)!0.65!(q1q)$) {};
  ...
  \draw [thick,out=60,in=120,color=blue] (q1p.center) to node (q1ps) [midway] {} (q1s.center);
  ...
  \node (q2s) at ($(q2p)!0.35!(q2q)$) {};
  \node (q2a) at ($(q2p)!0.5!(q2q)$) {};
  \node (q2c) at ($(q2p)!0.65!(q2q)$) {};
  ...
  \draw [thick,out=60,in=120,color=blue] (q2t.center) to node (q2ta) [midway] {} (q2a.center);
  ...
  \node (q3s) at ($(q3p)!0.35!(q3q)$) {};
  \node (q3a) at ($(q3p)!0.5!(q3q)$) {};
  \node (q3c) at ($(q3p)!0.65!(q3q)$) {};
  ...
  \draw [thick,out=60,in=120,color=blue] (q3t.center) to node (q3tb) [midway] {} (q3b.center);
  \node (q3) [fit=(q3p) (q3q) (q3ps) (q3pc) (q3ta) (q3tb)] {};

  \node (q4p) at (3, -6) {};
  \node (q4q) [right=\spanWidth of q4p] {};
  \node (q4t) at ($(q4p)!0.2!(q4q)$) {};
  \node (q4s) at ($(q4p)!0.35!(q4q)$) {};
  \node (q4a) at ($(q4p)!0.5!(q4q)$) {};
  \node (q4c) at ($(q4p)!0.65!(q4q)$) {};
  ...
  \draw [thick,out=60,in=120,color=blue] (q4s.center) to node (q4sc) [midway] {} (q4c.center);
  ...
  \node (q5s) at ($(q5p)!0.35!(q5q)$) {};
  \node (q5a) at ($(q5p)!0.5!(q5q)$) {};
  \node (q5c) at ($(q5p)!0.65!(q5q)$) {};
  ...
  \draw [thick,out=60,in=120,color=blue] (q5p.center) to node (q5pc) [midway] {} (q5c.center);
  ...
  \draw [thick,out=60,in=120,color=blue] (q6c.center) to node (q6cx) [midway] {} (q6x.center);
  ...
  \draw [thick,out=60,in=120,color=blue] (q7b.center) to node (q7bx) [midway] {} (q7x.center);
...
This chart shows how we define those decompositions.
Each rectangle poses a questions, using the black structure to express what is known, and the blue edge to ask the question: is such an edge present or not?
