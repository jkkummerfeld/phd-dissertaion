...
\hfill\parbox[c]{.22\textwidth}{\subcaption{\label{fig:repr-ptb}Standard \ptb structure.}}
\parbox[c]{.7\textwidth}{
\centering
% Standard form
\begin{tikzpicture}
[ every node/.style={
  ...
  \node (sntR0) at (-1.5, 1.8) {\strut};
  \node (w0) at (0, 0) {\strut Sarah};
  \node (w1) [right=3ex of w0.east] {\strut told};
  \node (w2) [right=3ex of w1.east] {\strut Rebecca};
...
\vspace{3mm}
\begin{minipage}{\textwidth}
\hfill\parbox[c]{.22\textwidth}{\subcaption{\label{fig:repr-lex-ptb}Lexicalized \ptb structure.}}
\parbox[c]{.7\textwidth}{
\centering
% Standard with heads
\begin{tikzpicture}
[ every node/.style={
  ...
  \node (nt21) [above=of nt20.north] {\strut};
  \node (nt31) [above=of nt30.north] {\strut NP\textsubscript{SBJ}};
  \node (nt41-51) [above=of nt50.north] {\strut VP};

  \node (nt02) [above=of nt01.north] {\strut};
  \node (nt12) [above=of nt11.north] {\strut};
  \node (nt22) [above=of nt21.north] {\strut NP\textsubscript{1}};
  \node (nt32-52) [above=of nt41-51.north] {\strut S};

  \node (nt03) [above=of nt02.north] {\strut NP\textsubscript{SBJ}};
  \node (nt13-53) [above=of nt12.north] {\strut VP};

  \node (nt04-54) [above=of nt13-53.north] {\strut S};
...
\vspace{3mm}
\begin{minipage}{\textwidth}
\hfill\parbox[c]{.22\textwidth}{\subcaption{\label{fig:repr-ours}Our representation.}}
\parbox[c]{.7\textwidth}{
\centering
% Split head form
\begin{tikzpicture}
[ every node/.style={
  ...
  \node (snt00) [right=1.5em of sntR0.east] {\strut NP\textsubscript{SBJ}};
  \node (sw0) [below=-0.3ex of snt00] {\strut Sarah};

  \node (snt10) [right=1.5em of snt00.east] {\strut S};
  ...
  \node (snt20) [right=2.5em of snt11.east] {\strut NP};
  \node (sw2) [below=-0.3ex of snt20] {\strut Rebecca};

  \node (snt30) [right=2.5em of snt20.east] {\strut -};
  \node (sw3) [below=-0.3ex of snt30] {\strut to};

  \node (snt50) [right=1.5em of snt30.east] {\strut S};
