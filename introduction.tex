...
We also define a new representation that is compatible with the algorithm and represents virtually all forms of linguistic structure in the Penn Treebank.
