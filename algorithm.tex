...
\begin{algorithmic}[]
  ...
  \For{each possible width, from 1 to the length of sentence}
    \For{each span\footnotemark mark of that width}
...
\end{algorithm}
\footnotetext{A continuous range, \myeg from 1 to 4 would be a span of width 3}
...
Crucially, our items are defined by a small number of values, such as the start and end points of the span, rather than their full internal structure.
...
To make the deduction rules manageable, we define only some constraints explicitly, and then use code to enumerate all options and enforce additional constraints.
...
\raisebox{1mm}{\parbox[b]{\deductionCaptionLength}{\captionof{figure}{\label{fig:rule-interval-a} $I$ deduction rules, case one.}}}
\end{minipage}
\vspace{5mm}
...
\hfill\begin{tikzpicture}
  ...
  \node (rtext) [below=\coordGap of rb.center] {\small \strut $q$};
\end{tikzpicture}\hfill
\raisebox{1mm}{\parbox[b]{\deductionCaptionLength}{\captionof{figure}{\label{fig:rule-interval-b} $I$ deduction rules, case two.}}}
\end{minipage}
\vspace{5mm}
...
\hfill\begin{tikzpicture}
  ...
  \node (rtext) [below=\coordGap of rb.center] {\small \strut $q$};
\end{tikzpicture}\hfill
\raisebox{4mm}{\parbox[b]{\deductionCaptionLength}{\captionof{figure}{\label{fig:rule-interval-c} $I$ deduction rules, cases three and five.}}}
\end{minipage}
\end{minipage}
\vspace{5mm}
...
\hfill\begin{tikzpicture}
  ...
  \node (rtext) [below=\coordGap of rb.center] {\small \strut $q$};
\end{tikzpicture}\hfill
\raisebox{4mm}{\parbox[b]{\deductionCaptionLength}{\captionof{figure}{\label{fig:rule-interval-d} $I$ deduction rules, case four.}}}
\end{minipage}
\vspace{5mm}
...
\hfill\begin{tikzpicture}
  ...
  \node (rtext) [below=\coordGap of rb.center] {\small \strut $q$};
\end{tikzpicture}\hfill
\raisebox{4mm}{\parbox[b]{\deductionCaptionLength}{\captionof{figure}{\label{fig:rule-interval-e} $I$ deduction rules, case seven.}}}
\end{minipage}
\vspace{5mm}
...
\hfill\begin{tikzpicture}
  ...
  \node (rtext) [below=\coordGap of rb.center] {\small \strut $q$};
\end{tikzpicture}\hfill
\raisebox{4mm}{\parbox[b]{\deductionCaptionLength}{\captionof{figure}{\label{fig:rule-interval-f} $I$ deduction rules, case six.}}}
\end{minipage}
\vspace{5mm}
...
\raisebox{1mm}{\parbox[b]{\deductionCaptionLength}{\captionof{figure}{\label{fig:rule-both-fail-b} $B$ structural pattern}}}
\end{minipage}
\vspace{5mm}
...
\hfill\begin{tikzpicture}
  ...
  \node (otext) [below=\coordGap of ob.center] {\small \strut $o$};
\end{tikzpicture}\hfill
\raisebox{4mm}{\parbox[b]{\deductionCaptionLength}{\captionof{figure}{\label{fig:rule-both} $B$ deduction rule.}}}
\end{minipage}
\vspace{5mm}
...
\hfill\begin{tikzpicture}
  ...
  \node (otext) [below=\coordGap of ob.center] {\small \strut $o$};
\end{tikzpicture}\hfill
\raisebox{5mm}{\parbox[c]{\deductionCaptionLength}{\captionof{figure}{\label{fig:rule-left-c} $L$ deduction rules, cases three through eight.}}}
\end{minipage}
\vspace{5mm}
...
\hfill\begin{tikzpicture}
  ...
  \node (otext) [below=\coordGap of ob.center] {\small \strut $o$};
\end{tikzpicture}\hfill
\raisebox{1mm}{\parbox[b]{\deductionCaptionLength}{\captionof{figure}{\label{fig:rule-left-a} $L$ deduction rules, cases one and two.}}}
\end{minipage}
\vspace{5mm}
...
\hfill\begin{tikzpicture}
  ...
  \node (otext) [below=\coordGap of ob.center] {\small \strut $o$};
\end{tikzpicture}\hfill
\raisebox{1mm}{\parbox[b]{\deductionCaptionLength}{\captionof{figure}{\label{fig:rule-left-b} $L$ deduction rules, cases nine and ten.}}}
\end{minipage}
\vspace{5mm}
...
The first two cases lead to multiple such edges, while the third case will only have one.
...
\hfill\begin{tikzpicture}
  ...
  \node (otext) [below=\coordGap of ob.center] {\small \strut $o$};
\end{tikzpicture}\hfill
\raisebox{1mm}{\parbox[b]{\deductionCaptionLength}{\captionof{figure}{\label{fig:rule-neither} $N$ deduction rule.}}}
\end{minipage}
\vspace{5mm}
...
\begin{subfigure}[t]{0.55\linewidth}
  ...
  \begin{minipage}[t]{0.34\linewidth}
    ...
    \begin{tikzpicture}
      ...
      \draw [dashed,out=45,in=135,->,thin,>=Stealth] (s0b.center) to (q0.center);
  ...
  \begin{minipage}[c]{0.4\linewidth}
    ...
    \begin{tikzpicture}
      ...
      \node (halfa) at ($(s0b)!0.5!(q0)$) {};
      \node (half) [above=3pt of halfa.center] {};
      \draw [dashed,out=135,in=45,->,thin,>=Stealth] (q0.center) to (s0b.center);
    \end{tikzpicture}
  \end{minipage}
  ...
  \begin{minipage}[c]{0.4\linewidth}
    ...
    \begin{tikzpicture}
      ...
      \node (half) [above=3pt of halfa.center] {};
      \draw [dashed,out=135,in=45,<-,thin,>=Stealth] (s0a.center) to (p0.center);
...
\begin{tikzpicture}
  ...
  \draw (p.north) -- (q.north);
  \draw [out=45,in=135,required undirected] (p.north) to (s.north);
...
\begin{finalEquation}
\caption{\label{alg:I:3:5}Making $I$, cases three and five (part one).}
...
Following an argument similar to the one above, we get the same derivation as shown in Algorithms~\ref{alg:I:4} and \ref{alg:I:3:5}, the only differences is that $[ps.t]$ must contain at least two $t$--$(ps)$ edges, and as a result the left item could be a $B$ now.

\begin{finalEquation}
\caption{Making $I$, cases three and five (part two).}
  $B\cdotp [psq \; F \; P\overline{Q} \; \overline{PS}] \quad I[sq \; . \; .]$ \\
  $B\cdotp [pst \; F \; P\overline{T} \; \overline{PS}] \quad I[st \; . \; .] \quad I[tq \; . \; .]$
\end{finalEquation}
...
\begin{tikzpicture}
  ...
  \draw (p.north) -- (q.north);
  \draw [out=45,in=135,required undirected] (p.north) to (s.north);
  \draw [out=45,in=135,required undirected] (p.north) to (ts.north);
  \draw [out=45,in=135,required undirected] (t.north) to (sq.north);
  \draw [out=45,in=135,required undirected] (t.north) to (sq2.north);
\end{tikzpicture}
\end{center}

In this case there are no $(pt)$--$(ts]$ edges, and no $(ts)$--$(sq]$ edges, because they would violate the \oneEC property for the edges in $C$.
...
In all six of these rules, the chaining property from the previous section is not present.
