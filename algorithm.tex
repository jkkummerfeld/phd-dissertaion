...
\paragraph{Cycle}
A sequence of edges that begin and end at the same vertex (here we only allow traversal of edges in the direction indicated).
...
Note that by only using subsets of the rules in our algorithm, we could restrict the space of structures we generate to the projective tree space, the projective DAG space, or the tree space.
...
% TODO: Add a section 'why graphs?' mainly referring back to the intro
% TODO: First sketch general CKY and the idea of defining deduction rules
...
In this section we sketch our algorithm, defining all of the key ideas needed to understand the deduction rules.
...
We present the algorithm from a top-down perspective to easily show how it is and is not complete.
In practice, when parsing we use a bottom-up approach (the deduction rules apply equivalently in either direction).
The intuition for the algorithm is that items are either a span of the sentence in which all of the structure is complete, or a span plus a point outside the span, with some connection between the two.
Edges can only be added between three points: the left end of the span, the right end of the span, and the point outside.
Edges added between the two ends of the span will not be crossed, except if the item has an exterior point, in which case the edge is crossed as soon as it is added.
Edges added between either end of the span and the exterior point will be crossed later in the derivation.
...
\raisebox{4mm}{\parbox[b]{2in}{\captionof{figure}{\label{fig:rule-interval-a}}}}
\end{minipage}
\vspace{5mm}
...
\hfill\begin{tikzpicture}
  ...
  \node (rtext) [below=\coordGap of rb.center] {\small \strut $q$};
\end{tikzpicture}\hfill
\raisebox{4mm}{\parbox[b]{2in}{\captionof{figure}{\label{fig:rule-interval-b}}}}
\end{minipage}
\vspace{5mm}
...
\hfill\begin{tikzpicture}
  ...
  \node (rtext) [below=\coordGap of rb.center] {\small \strut $q$};
\end{tikzpicture}\hfill
\raisebox{4mm}{\parbox[b]{2in}{\captionof{figure}{\label{fig:rule-interval-d}}}}
\end{minipage}
\vspace{5mm}
...
\hfill\begin{tikzpicture}
  ...
  \node (rtext) [below=\coordGap of rb.center] {\small \strut $q$};
\end{tikzpicture}\hfill
\raisebox{4mm}{\parbox[b]{2in}{\captionof{figure}{\label{fig:rule-interval-c}}}}
\end{minipage}
\vspace{5mm}
...
\hfill\begin{tikzpicture}
  ...
  \node (rtext) [below=\coordGap of rb.center] {\small \strut $q$};
\end{tikzpicture}\hfill
\raisebox{4mm}{\parbox[b]{2in}{\captionof{figure}{\label{fig:rule-interval-f}}}}
\end{minipage}
\vspace{5mm}
...
\hfill\begin{tikzpicture}
  ...
  \node (rtext) [below=\coordGap of rb.center] {\small \strut $q$};
\end{tikzpicture}\hfill
\raisebox{4mm}{\parbox[b]{2in}{\captionof{figure}{\label{fig:rule-interval-e}}}}
\end{minipage}
\vspace{5mm}
...
\end{tikzpicture}\hfill
\raisebox{4mm}{\parbox[b]{2in}{\captionof{figure}{\label{fig:rule-both-fail-a}}}}
\end{minipage}
\vspace{5mm}
...
\raisebox{4mm}{\parbox[b]{2in}{\captionof{figure}{\label{fig:rule-both-fail-b}}}}
\end{minipage}
\vspace{5mm}
...
\hfill\begin{tikzpicture}
  ...
  \node (otext) [below=\coordGap of ob.center] {\small \strut $o$};
\end{tikzpicture}\hfill
\raisebox{4mm}{\parbox[b]{2in}{\captionof{figure}{\label{fig:rule-both}}}}
\end{minipage}
\vspace{5mm}
...
\hfill\begin{tikzpicture}
  ...
  \node (otext) [below=\coordGap of ob.center] {\small \strut $o$};
\end{tikzpicture}\hfill
\raisebox{4mm}{\parbox[c]{2in}{\captionof{figure}{\label{fig:rule-left-c}}}}
\end{minipage}
\vspace{5mm}
...
\hfill\begin{tikzpicture}
  ...
  \node (otext) [below=\coordGap of ob.center] {\small \strut $o$};
\end{tikzpicture}\hfill
\raisebox{4mm}{\parbox[b]{2in}{\captionof{figure}{\label{fig:rule-left-a}}}}
\end{minipage}
\vspace{5mm}
...
\hfill\begin{tikzpicture}
  ...
  \node (otext) [below=\coordGap of ob.center] {\small \strut $o$};
\end{tikzpicture}\hfill
\raisebox{4mm}{\parbox[b]{2in}{\captionof{figure}{\label{fig:rule-left-b}}}}
\end{minipage}
\vspace{5mm}
...
\hfill\begin{tikzpicture}
  ...
  \node (otext) [below=\coordGap of ob.center] {\small \strut $o$};
\end{tikzpicture}\hfill
\raisebox{4mm}{\parbox[b]{2in}{\captionof{figure}{\label{fig:rule-neither}}}}
\end{minipage}
\vspace{5mm}
...
The clean division of cases between edges that will be crossed and those that will be not is partially due to choices we made in the definition of the deduction rules; it does not hold for \textcite{ec}'s algorithm.

Comparing th definitions of our items with the items in \textcite{ec}, we have one entirely new type, the Exterval, and we have added the requirement that the later items have at least one crossing of the specified type.
...
Since our item types are entirely disjoint, throughout the rules we need to give multiple options for item types in many places where \textcite{ec} give only one type.

If $|C| = 1$, let $t$ be the endpoint outside $ps$.
(this is one source of ambiguity in \textcite{ec}).
