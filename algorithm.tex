...
%TODO: Look at reviews for what else to add
...
In this chapter, we propose a new representation and algorithm for a restricted class of graph structures that are flexible enough to cover almost all treebank structures, yet are restricted enough to admit efficient learning and inference.
...
% TODO: Make Venn diagram of tree, graph, DAG, projective, 1ec
