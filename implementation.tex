...
While the core algorithm is fully described in the previous sections, and has desireable assymptotic speed properties, a simple implementation would be slow.
...
To understand what structures are still not covered by our approach we manually inspected twenty examples that contained a cycle and twenty examples where the structure did not satsify the one-endpoint-crossing property.
